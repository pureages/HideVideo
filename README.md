...
```
Note: The directory for adding video libraries is /app/data/……, and your video folder should be placed in $(pwd)/data! $(pwd) defaults to your username, but you can also customize the path!
